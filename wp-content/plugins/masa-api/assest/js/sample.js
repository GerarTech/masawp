...
jQuery(document).ready(function(){
    jQuery('#check-button').click(function(e){
        ...
        var site_url = jQuery('#masa_site_url').val();
        ...
        var httpMethod = 'GET';
       // var surl = 'http://localhost/masa/wp-admin/admin-ajax.php';
    ...
    console.log(signature);
        jQuery.ajax({
          ...
          data : {
                    action: "masa_token_request_ajax", 
	...
	signature = oauthSignature.generate(httpMethod, surl, parameters, consumerSecret, tokenSecret, { encodeSignature: false});
        ...
        jQuery.ajax({
          ...
          url : request_token.ajaxurl,
          data : {
                    action: "masa_token_request_ajax_final",
                    client_key : client_key,
                    client_secret:client_secret,
                    parameters : parameters,
                    // encodedSignature : encodedSignature,
