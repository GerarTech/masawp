<?php
add_action("wp_ajax_masa_token_request_ajax", "masa_token_request_ajax");
add_action("wp_ajax_nopriv_masa_token_request_ajax", "masa_token_request_ajax");

function masa_token_request_ajax()
{
    ...
    $response = wp_remote_get(get_home_url() . '/oauth1/request'.$params, array(
        'body' => null,
    ...
    // ));
    $obj = (array) json_decode(json_encode($response), true);
...
add_action("wp_ajax_masa_token_request_ajax_final", "masa_token_request_ajax_final");
add_action("wp_ajax_nopriv_masa_token_request_ajax_final", "masa_token_request_ajax_final");

function masa_token_request_ajax_final()
{
    ...
    $response = wp_remote_get(get_home_url() . '/oauth1/access'.$params.'&oauth_verifier=' . $_REQUEST['oauth_verifier'], array(
        'body' => null,
